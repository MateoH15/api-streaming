function Sidebar({ onSelectPlatform, currentView }) {
  return (
    <aside className="w-64 shrink-0 bg-slate-900 border-r border-slate-800 h-[calc(100vh-73px)] p-5 overflow-y-auto">
      {/* Home Button */}
      <div
